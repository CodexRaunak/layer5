...
The fastest on-time repair is a symlink. A symlink makes the skill directory appear in both locations simultaneously without duplicating any files. Changes to the skill (updates, edits) are reflected in both paths automatically.
