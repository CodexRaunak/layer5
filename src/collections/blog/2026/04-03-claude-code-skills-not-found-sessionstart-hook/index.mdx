...
The <code>npx skill</code> comman comes from the <a href="https://github.com/anthropics/claude-code" target="_blank" rel="noopener noreferrer">Claude Code ecosystem</a> and follows the <a href="https://agentprotocol.ai" target="_blank" rel="noopener noreferrer">Agent Protocol</a> convention for storing agent assets. Under that convention, skills live at:
